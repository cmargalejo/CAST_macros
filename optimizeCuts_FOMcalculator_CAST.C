...
std::pair<double, double> getScalingFactor(int energyIdx, std::string obs){
    ...
    std::map<std::string, std::map<int, std::pair<double, double>>> map = {
        { "(tckAna_MaxTrackEnergy_X-tckAna_MaxTrackEnergy_Y)/(tckAna_MaxTrackEnergy_X+tckAna_MaxTrackEnergy_Y)", {
                { 1,  { 2.15, 1.76 }  },
                { 2,  { 1.71, 1.41 }  },
                { 3,  { 1.42, 1.21 }  },
                { 4,  { 1.13, 1.07 }  },
...
std::pair<double, double> getInitialCut(DataKind dKind, std::string obs){
    ...
    std::map<std::string, std::pair<double, double>> castMap = {
        { "(tckAna_MaxTrackEnergy_X-tckAna_MaxTrackEnergy_Y)/(tckAna_MaxTrackEnergy_X+tckAna_MaxTrackEnergy_Y)",  { -0.22, 0.22 }  },
        { "tckAna_MaxTrack_XZ_GaussSigmaX",  { 0.15, 0.7 }  },
    ...
    std::map<std::string, std::pair<double, double>> xrayTubeMap = {
        { "(tckAna_MaxTrackEnergy_X-tckAna_MaxTrackEnergy_Y)/(tckAna_MaxTrackEnergy_X+tckAna_MaxTrackEnergy_Y)",  { -0.165, 0.174 }  },
        { "tckAna_MaxTrack_XZ_GaussSigmaX",  { 0.225, 0.775 }  },
        { "tckAna_MaxTrack_YZ_GaussSigmaY",  { 0.225, 0.875 }  },
        { "hitsAna_z2Sigma",  { 0.0, 1.25 }  },
        { "tckAna_MaxTrackxySigmaGausBalance",  { -0.41, 0.49 }  },
