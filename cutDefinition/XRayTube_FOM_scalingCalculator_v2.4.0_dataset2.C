...
// Major updates by Cristina Margalejo, June 2023
...
ROOT::RDF::RNode calcEnergy(ROOT::RDF::RNode df, int energyIdx, DataKind dKind){
    switch(dKind) {
        case dkBackground:
            return df.Define("energy_keV","tckAna_MaxTrackEnergy/1360");
        case dkXrayTube:
...
void cut(std::string cutstring, int energyIdx, double cutScaling) {
    ...
    fileNamesBg.push_back(path + "final/R10671*");
    fileNamesBg.push_back(path + "final/R10690*");
    fileNamesBg.push_back(path + "final/R10691*");
    fileNamesBg.push_back(path + "final/R10781*");
    fileNamesBg.push_back(path + "final/R10793*");
    fileNamesBg.push_back(path + "final/R10795*");
    fileNamesBg.push_back(path + "final/R10796*");
    fileNamesBg.push_back(path + "final/R10800*");
    fileNamesBg.push_back(path + "final/R10802*");
    fileNamesBg.push_back(path + "final/R10805*");
    fileNamesBg.push_back(path + "final/R10807*");
    fileNamesBg.push_back(path + "final/R10811*");
    fileNamesBg.push_back(path + "final/R10822*");
    fileNamesBg.push_back(path + "final/R10822*");
    fileNamesBg.push_back(path + "final/R10824*");
    fileNamesBg.push_back(path + "final/R10826*");
    fileNamesBg.push_back(path + "final/R10828*");
    fileNamesBg.push_back(path + "final/R10830*");
    fileNamesBg.push_back(path + "final/R10832*");
    fileNamesBg.push_back(path + "final/R10834*");
    fileNamesBg.push_back(path + "final/R10836*");
    fileNamesBg.push_back(path + "final/R10838*");
    fileNamesBg.push_back(path + "final/R10840*");
    fileNamesBg.push_back(path + "final/R10842*");
    fileNamesBg.push_back(path + "final/R10843*");


    // Fe55 runs

    fileNamesFe55.push_back(path + "trackAnalysis/R10837*");
