...
void cut(std::string cutstring) {
	...
	// Background runs
    //fileNamesBg.push_back(path + "R10512*Background*root");
    //fileNamesBg.push_back(path + "R101*Background*root");
    //fileNamesBg.push_back(path + "R10178*Background*root");
    //fileNamesBg.push_back(path + "R10182*Background*root"); // source was in
    //fileNamesBg.push_back(path + "R10188*Background*root");
    //fileNamesBg.push_back(path + "R1019[0246]*Background*root");
    /*
	fileNamesBg.push_back(path + "R102*Background*root");
	fileNamesBg.push_back(path + "R103*Background*root");
	fileNamesBg.push_back(path + "R104*Background*root");
	fileNamesBg.push_back(path + "R105*Background*root");
    */
    fileNamesBg.push_back(path + "background_df_all_runs_incArDataset2HitChannels_v2.4.0_final_withRateAna_withAllSC.root"); //background_df_all_runs.root; background_df_all_runs_dataset2.root; background_df_all_runs_dataset1_incArDataset2HitChannels.root; background_df_all_runs_incArDataset2HitChannels_notScaledSigmaCsv.root; background_df_all_runs_incArDataset2HitChannels_notScaledSigmaCsv.root background_df_all_runs_incArDataset2HitChannels_newSigmaZ.root
    //v2.4.0 final ones: background_df_all_runs_incArDataset2HitChannels_v2.4.0_final.root;
