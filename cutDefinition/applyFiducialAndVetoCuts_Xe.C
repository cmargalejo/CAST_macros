...
*/
	...
	bgData2 = bgData.Define("vetoAmplitude", extractSecond, {"veto_MaxPeakAmplitude"});//"vetoAmplitude","veto_MaxPeakAmplitude.second");
    ...
    */
    ...
    auto histo1 = bgData_filtered.Histo1D({"energy_keV", "Energy", 48, 0, 12}, "energy_keV");
