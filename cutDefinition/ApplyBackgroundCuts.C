...
std::pair<double, double> getInitialCut(DataKind dKind, std::string obs){
    ...
    std::map<std::string, std::pair<double, double>> castMap = {
        { "tckAna_MaxTrackEnergyBalanceXY",  { -0.22, 0.22 }  },
    ...
    std::map<std::string, std::pair<double, double>> xrayTubeMap = {
        { "tckAna_MaxTrackEnergyBalanceXY",  { -0.165, 0.174 }  },
...
void cut() {
    ...
    string path = "/storage/cast/SR2019/analysis/argon/official/";  // data path
    ...
    */
    ...
    //fileNamesBg.push_back(path + commonPrefix + "/R10388*");
    //fileNamesBg.push_back(path + commonPrefix + "/R10390*");
    //fileNamesBg.push_back(path + commonPrefix + "/R10402*");
