...
c1 = candidate_weights(dataset_Ar1, 0, 0)*0.02*0.02 # 4 cm^2 is the area of my 2x2 cm rectangle going form 10mm to 10 mm in X and Y
...
xMax = 10
xSize = 2.0 / n
c2 = candidate_weights(dataset_Xe, 0, 0)*area # 4 cm^2 is the area of my 2x2 cm rectangle going form 10mm to 10 mm in X and Y
print("Weight of a candidate at (0,0) if applied to a pixel out of 1000x1000: ", c2)
