...
def perform_interpolation(filename, csv_filename):
    ...
    #plt.imshow(zzs.T, extent=(-10, 10, -10, 10), origin = "lower")
    ...
    contour_levels = np.percentile(df["z"], [68,85,95,99]) #zs or z?
    contour_levels_no_zeroes = np.percentile(zNonZero["z"], [68,85,95,99]) #zs or z?
    #Print the percentiles used in a text box
    
    percentile_values = [68, 85, 95, 99]
...
map_filename = '/home/cristina/GitHub/CAST_macros/limitCalculation/data/llnl_raytracing_Jaime_all_energies.txt'
